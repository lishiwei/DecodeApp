...
public class PhotoPickerActivity extends BasePickerActivity implements PickerAction {
                    ...
                    if (mode == SImagePicker.MODE_IMAGE) {
                        photoController.getAllPhoto(new PhotoLoadListener() {
                            ...
                            public void onLoadComplete(ArrayList<Uri> photoUris) {
                                SImagePicker.photoUriList = photoUris;
                                if (!CollectionUtils.isEmpty(photoUris)) {
                                    Log.i("Photo", "startPicturePreviewFromPicker start");
                                    PickerPreviewActivity.startPicturePreviewFromPicker(PhotoPickerActivity.this, photoController.getSelectedPhoto(), position,
                        ...
                        CropImageActivity.startImageCrop(PhotoPickerActivity.this, photo.getFilePath(),
                                REQUEST_CODE_CROP_IMAGE, avatarFilePath, aspectX, aspectY);
                    }
                }
            };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        aspectX = getIntent().getIntExtra(CropImageActivity.PARAM_ASPECTX, 1);
        aspectY = getIntent().getIntExtra(CropImageActivity.PARAM_ASPECTY, 1);
        photoPath = getIntent().getStringExtra(PARAM_PHOTO_PATH);
        initUI();
    }
    ...
    private void initUI() {
        ...
        if (!showCamera) {
            ...
            capturePhotoHelper = new CapturePhotoHelper(this, photoPath);
            photoController.onCreate(this, recyclerView, selectionChangeListener, maxCount, rowCount,
    ...
    protected void onDestroy() {
        ...
        SImagePicker.photoUriList = null;
        super.onDestroy();
    }
                ...
                if (mode == SImagePicker.MODE_AVATAR) {
                    ...
                    if (photoFile != null) {
                        CropImageActivity.startImageCrop(this, photoFile.getAbsolutePath(),
                                ...
                                avatarFilePath, aspectX, aspectY);
                    }
                } else {
                    File photoFile = capturePhotoHelper.getPhoto();
                    ArrayList<String> result = new ArrayList<>();
