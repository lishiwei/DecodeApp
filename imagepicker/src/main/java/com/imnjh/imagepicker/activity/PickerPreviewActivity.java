...
public class PickerPreviewActivity extends BasePickerActivity implements PickerAction {
    ...
    private static final String TAG = PickerPreviewActivity.class.getSimpleName();
     ...
     */
    public static void startPicturePreviewFromPicker(Activity activityContext, ArrayList<String> selected, int currentPosition,
                                                     ...
                                                     int requestCode) {
        Log.i(TAG, "startPicturePreviewFromPicker");
    ...
    private void initUI() {
        ...
        ArrayList<Uri> uriParam = SImagePicker.photoUriList;
