...
import com.xys.libzxing.zxing.decode.DecodeHandler;
...
public class CaptureActivityHandler extends Handler {
    ...
    public void setIsDecodingMode(boolean isDecoding) {
        ((DecodeHandler)decodeThread.getHandler()).setIsDecodingMode(isDecoding);
    }
